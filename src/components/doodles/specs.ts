/**
 * The authored background doodles: twelve hand-drawn SVG paths with their
 * placement, weight and colour. The register keeps hand-drawn marks on the
 * background layer only (docs/UI.md), so this list is the whole vocabulary.
 */
